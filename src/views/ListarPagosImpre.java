 ...
 * @author ERIK RUBIO
 */
public class ListarPagosImpre extends javax.swing.JFrame {

    /**
     * Creates new form imprimir
     */
    public ListarPagosImpre() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarPagosImpre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListarPagosImpre().setVisible(true);
            }
        });
    }
